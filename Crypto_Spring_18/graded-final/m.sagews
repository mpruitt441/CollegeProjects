...
assert (d*e)%phi_N == 1
signed = pow(thing_to_sign,d,N) #(thing_to_sign ** e) % N
...
︡af8591bd-447c-4f9a-a65d-520fe18ee30f︡{"stdout":"N= 11783958142897916431882301185888352387993287628820763207160455146708227855773\n"}︡{"stdout":"e= 7\n"}︡{"stdout":"d= 3366845183685118980537800338825243539333764870635049259135683154378007034871\n"}︡{"stdout":"Thing to sign =  105627108855101827529740540144339953915874516805280786479090741954050376924960\n"}︡{"stdout":"Signed =  2576772681399981009909599056395665344453805301102144934331155849714695315814\n"}︡{"done":true}︡
